...
const LOADER = {
  ...
  Isomorphic_Loader: 'isomorphic-style-loader'
};
...
exports.getAllStyleRelatedLoaders = function(
  ...
  let styleLoader = LOADER.Isomorphic_Loader;
  ...
  return [
    {
      ...
      use: exports.getStyleLoaders(
        ...
        styleLoader,
        LOADER.CSS_LOADER,
        // !DEV_MODE && LOADER.Isomorphic_Loader
      ),
    },
    {
...
exports.getIsomorphicLoader = function(plugins = []) {
  return {
    loader: LOADER.Isomorphic_Loader
  };
};